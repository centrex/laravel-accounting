    ...
    protected function seedChartOfAccounts(): void
    {
        $accounts = [
            ...
            [
                ...
                'type'      => AccountType::EXPENSE,
                'subtype'   => AccountSubtype::POSTAGE_AND_SHIPPING_EXPENSE,
                'is_system' => true,
            ],
            [
                'code'      => '4220',
            ...
            [
                'code'      => '5501',
                'name'      => 'Early Payment Discount (Purchase)',
                'type'      => AccountType::EXPENSE,
                'subtype'   => AccountSubtype::COST_OF_GOODS_SOLD,
                'is_system' => true,
            ],
            ...
            [
                'code'      => '6320',
                'name'      => 'Shipping / Transfer Bill (Carriage)',
                'type'      => AccountType::EXPENSE,
                'subtype'   => AccountSubtype::POSTAGE_AND_SHIPPING_EXPENSE,
                'is_system' => true,
            ],
