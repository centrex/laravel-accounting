<div>
    ...
    <x-tallui-page-header
        ...
        subtitle="Outstanding payables grouped by age bucket, as of selected date"
    ...
    >
        ...
        <x-slot:actions>
            ...
            <a href="{{ route('accounting.bills') }}" wire:navigate class="btn btn-sm btn-ghost gap-1">
                <x-tallui-icon name="o-clipboard-document-list" size="w-4 h-4" />
                Bills
            </a>
        </x-slot:actions>
    </x-tallui-page-header>
    ...
    <div class="p-4 md:p-6 space-y-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            ...
            @endforeach
            <div class="stat bg-base-100 rounded-xl border border-base-200 shadow-sm p-3">
                <div class="stat-title text-xs text-base-content/60">Total AP</div>
        ...
        {{-- Per-vendor detail table --}}
        <x-tallui-card title="Vendor Breakdown" :shadow="true" padding="normal">
            ...
            @else
                <x-tallui-empty-state
                    ...
                    description="All bills are settled as of {{ $report['as_of_date'] }}."
