        ...
        <table class="table table-sm w-full">
            ...
            <tbody class="divide-y divide-base-200">
                @forelse($customers as $customer)
                    <tr class="even:bg-base-200/50 hover:bg-base-200 {{ !$customer->is_active ? 'opacity-60' : '' }}">
                        ...
                        <td class="pr-5">
                            <div class="flex justify-end gap-1">
                                ...
                                <x-tallui-button wire:click="openAuditTrail({{ \Illuminate\Support\Js::from($customer::class) }}, {{ $customer->getKey() }}, {{ \Illuminate\Support\Js::from($customer->name) }})" icon="o-clock" class="btn-ghost btn-xs" title="Audit trail" />
