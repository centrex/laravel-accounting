                    ...
                    <tr class="even:bg-base-200/50 hover:bg-base-200 {{ !$vendor->is_active ? 'opacity-60' : '' }}">
                        ...
                        <td class="pr-5">
                            <div class="flex justify-end gap-1">
                                ...
                                <x-tallui-button wire:click="openAuditTrail({{ \Illuminate\Support\Js::from($vendor::class) }}, {{ $vendor->getKey() }}, {{ \Illuminate\Support\Js::from($vendor->name) }})" icon="o-clock" class="btn-ghost btn-xs" title="Audit trail" />
