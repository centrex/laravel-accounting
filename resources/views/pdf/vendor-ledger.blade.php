...
<body>
    <h1>Supplier Ledger — Statement of Account</h1>
    <div class="meta">
        {{ $vendor->name }} ({{ $vendor->code }}) &middot; Generated {{ $generatedAt->format('F d, Y h:i A') }}
    </div>
    ...
    <div class="info">
        ...
        <span><strong>Currency:</strong> {{ $vendor->currency }}</span>
    </div>

    <div class="summary">
        <div class="label">Outstanding Payable</div>
        <div class="value">{{ $vendor->currency }} {{ number_format($ledger['closing'], 2) }}</div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Description</th>
                <th style="width: 14%;" class="text-right">Billed</th>
