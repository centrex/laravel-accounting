...
class FinancialReports extends Component
{
    ...
    private function resolveReportData(): ?array
    {
        ...
        return match ($this->reportType) {
            ...
            'cash_flow_forecast'  => $service->getCashFlowForecast($this->endDate, sbuCode: $this->normalizedSbuCode()),
            'cash_book'           => $service->getCashBook(null, $this->startDate, $this->endDate, $this->normalizedSbuCode()),
